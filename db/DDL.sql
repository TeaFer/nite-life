...
ALTER TABLE "event" ADD FOREIGN KEY ("host_id") REFERENCES "account" ("id");
...
ALTER TABLE "ticket" ADD FOREIGN KEY ("owner_id") REFERENCES "account" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
